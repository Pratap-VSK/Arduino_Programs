...
// QUESTION: Use the serial monitor in the arduino IDE to display a massage "Hello" upon successfully uploading a sketch . How does the serial monitor help in debuging/..
...
//  QUESTION: Write a program for interfacing DHT 11 sensor and display data generated by sensor on LCD/..
...
// QUESTION: Write a program to use a button as a toggle switch for buzzer/..
